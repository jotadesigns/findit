...
<body class="hdnav-empresa">
	<nav class="hdnav ">
		<div class="hdnavpad">
			<div class="row">
				<div class="nav-logo col-xs-5 col-sm-5 col-md-6 col-lg-6">
						<a class="link link--nukun" href="{{ url('/').'/'.LaravelLocalization::getCurrentLocale().'/empresas' }}">Fin<span>d</span> it - empresas</a>
				</div>
			        ...
			        <ul class="nav-enlaces">
						...
						<nav class="nav-languages">
							<div class="nav-languages-text">
								<a id="language-activate" >@lang('layouts.language')</a>
							</div>
