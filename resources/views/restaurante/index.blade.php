...
<div id="restaurante" class="row">
                                ...
                                <ul id="menunav_restaurante">
                                    ...
                                    <div class="cuadromenu_restaurante col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                        ...
                                        <li>
                                            ...
                                            <p class="descmenu_restaurante">  {{$datos_restaurante["result"]["formatted_phone_number"]}}</p>
                                    ...
                                    <div class="cuadromenu_restaurante col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                         ...
                                         <li>
                                              <a href="http://maps.google.com/?q={{$datos_restaurante['result']['vicinity']}}">
                                             <i class="icononavegacion_restaurante ion-ios-navigate-outline"></i>
                                               <p class="descmenu_restaurante" style="margin-top: -5px;">¿Donde está?</p>
                                              </a>
           ...
           <div class="container">
               ...
               <div style="padding-left:35%; margin-top:15px; margin-bottom:15px;">
                 <a class="btn btn-warning" style="color:black; font-weight: bold;" href="{{url('/empresas/')}}">¿Quieres controlar este restaurante? FIND IT Empresas</a>
              </div>
            </div>
